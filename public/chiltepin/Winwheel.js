$(function() {
  ...
  document.getElementById("pw3").addEventListener("click", powerSelected(3));
  document.getElementById("pw2").addEventListener("click", powerSelected(2));
  document.getElementById("pw1").addEventListener("click", powerSelected(1));
...
function myScript() {
  ...
  if (this.innerHTML == "No, no se pero equis") {

    if (buttonOne.innerHTML == "Si, la neta que si") {
      buttonOne.innerHTML = "No, no se pero equis";
      buttonTwo.innerHTML = "Si, la neta que si";
    }

    else if (buttonOne.innerHTML == "No, no se pero equis") {
      buttonOne.innerHTML = "Si, la neta que si";
      buttonTwo.innerHTML = "No, no se pero equis";
    }
  }

  else {
    window.alert("jajaja no te hagas la santa si yo se que te encanta");
    $('#invisible').show();
  }
}
